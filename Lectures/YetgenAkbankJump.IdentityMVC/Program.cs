...
builder.Services.AddDbContext<YetgenIdentityContext>(opt => opt.UseNpgsql(connectionString)); //anonym function
...
builder.Services.AddIdentity<User, Role>(options =>
{
    ...
    options.User.RequireUniqueEmail = true; // you can create different user with one email
